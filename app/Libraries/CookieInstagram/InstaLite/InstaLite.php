...
use App\Libraries\CookieInstagram\InstaLite\Request;
...
class InstaLite
{
    ...
    {
        $this->sessionPatch = config('session.files') . '/' ?? __DIR__ . '/session/';
    ...
    private function __login()
    {
        ...
        if (isset($response['message'])) {
            throw new Exception("Error Authorization! " . $response['message']);
        }
